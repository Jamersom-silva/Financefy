      ...
      <main className="min-h-screen bg-gray-50 pt-28 pb-20 px-6">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Explore o <strong>Financefy</strong> com dados fictícios e veja como
            o sistema ajuda você a entender e controlar suas finanças pessoais.
          </p>
        </motion.section>
