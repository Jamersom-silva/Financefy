...
export default function Footer() {
    ...
    return (
      <footer className="border-t border-gray-200 bg-white py-6 text-center">
        <p className="text-sm text-gray-500">
          ...
          <span className="font-semibold text-gray-900">Financefy</span>. Todos os
          direitos reservados.
        </p>
      </footer>
    );
  ...
  // ======================================================
  // 🔹 Footer completo (todas as outras páginas)
  // ======================================================
  return (
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-10 px-6 py-10 md:flex-row md:items-start">
        ...
        <div className="flex flex-col items-center gap-3 text-center md:items-start md:text-left">
          ...
          <p className="max-w-xs text-sm text-gray-600">
            Gerencie suas finanças de forma simples, clara e eficiente.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 text-sm text-gray-600 md:items-start">
          ...
          <Link to="/about" className="transition hover:text-[--color-primary]">
            Sobre
          </Link>

          {/* 🔥 ROTA CORRETA */}
          <Link to="/privacy" className="transition hover:text-[--color-primary]">
            Política de Privacidade
          </Link>

          <Link to="/contact" className="transition hover:text-[--color-primary]">
            Contato
          </Link>
        </div>
