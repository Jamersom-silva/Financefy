...
import { HelpCircle, Mail, ArrowLeft, BookOpen, MessageSquare } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          >
            <ArrowLeft size={16} />
            {token ? "Voltar ao Dashboard" : "Voltar ao Início"}
          </button>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        ...
        <section className="grid gap-6 md:grid-cols-3">
          ...
          >
            <FAQItem q="Como cadastro uma nova conta?" a="Acesse Dashboard → Contas → Novo. Informe nome e saldo inicial." />
            <FAQItem q="Posso editar categorias?" a="Sim. Vá em Dashboard → Categorias para criar, editar ou remover." />
            <FAQItem q="Os gráficos não aparecem, e agora?" a="Verifique se há transações no período filtrado e se o servidor da API está ativo." />
          </Card>
        ...
        <section className="mt-10 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <FAQItem
              ...
              a="No Painel, use os seletores de Mês e Ano para filtrar os dados exibidos."
              large
            />
            <FAQItem
