    ...
    <div className="min-h-screen bg-gray-50 px-6 py-12">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          coletamos, usamos e protegemos as informações fornecidas durante o uso do <strong>Financefy</strong>.
        </p>

        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-2">1. Coleta de informações</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          Coletamos apenas informações essenciais para o funcionamento da aplicação, como dados de 
          autenticação e preferências do usuário. Nenhuma informação pessoal é compartilhada com 
